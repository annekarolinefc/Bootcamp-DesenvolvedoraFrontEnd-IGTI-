...
function teste() {
  ...
  //console.log("i: " + i); //VAR EXISTE DO LADO DE DENTRO DO ESCOPO E DO LADO DE FORA - GLOBAL
  //console.log("j: " + j); // erro, o escopo de j é restrito ao for // LET SO EXISTE NO ESCOPO INTERNO
}
teste();
*/
...
// 3. Spread operator - CLONAR OBJETOS EM JS
/*
let primos = [2, 3, 5, 7, 11, 13];
